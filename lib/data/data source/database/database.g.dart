...
class _$AppDatabase extends AppDatabase {
  ...
  AllFavoriteJobDao? _allFavoriteJobInstance;
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `RecentJob` (`id` INTEGER, `name` TEXT, `image` TEXT, `jobTimeType` TEXT, `jobType` TEXT, `jobLevel` TEXT, `jobDescription` TEXT, `jobSkill` TEXT, `compName` TEXT, `compEmail` TEXT, `compWebsite` TEXT, `aboutComp` TEXT, `location` TEXT, `salary` TEXT, `favorites` INTEGER, `expired` INTEGER, `createdAt` TEXT, `updatedAt` TEXT, PRIMARY KEY (`id`))');
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `SuggestedJob` (`id` INTEGER, `name` TEXT, `image` TEXT, `jobTimeType` TEXT, `jobType` TEXT, `jobLevel` TEXT, `jobDescription` TEXT, `jobSkill` TEXT, `compName` TEXT, `compEmail` TEXT, `compWebsite` TEXT, `aboutComp` TEXT, `location` TEXT, `salary` TEXT, `favorites` INTEGER, `expired` INTEGER, `createdAt` TEXT, `updatedAt` TEXT, PRIMARY KEY (`id`))');
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `AllFavoriteJob` (`id` INTEGER, `userId` INTEGER, `like` INTEGER, `jobId` INTEGER, `image` TEXT, `name` TEXT, `location` TEXT, `createdAt` TEXT, `updatedAt` TEXT, PRIMARY KEY (`id`))');
        await database.execute(
  ...
  AllFavoriteJobDao get allFavoriteJob {
    return _allFavoriteJobInstance ??=
        _$AllFavoriteJobDao(database, changeListener);
  }
...
class _$AllFavoriteJobDao extends AllFavoriteJobDao {
  _$AllFavoriteJobDao(
    this.database,
    this.changeListener,
  )   : _queryAdapter = QueryAdapter(database, changeListener),
        _allFavoriteJobInsertionAdapter = InsertionAdapter(
            database,
            'AllFavoriteJob',
            (AllFavoriteJob item) => <String, Object?>{
                  'id': item.id,
                  'userId': item.userId,
                  'like': item.like,
                  'jobId': item.jobId,
            ...
            changeListener),
        _allFavoriteJobUpdateAdapter = UpdateAdapter(
            database,
            'AllFavoriteJob',
            ['id'],
            (AllFavoriteJob item) => <String, Object?>{
  ...
  final InsertionAdapter<AllFavoriteJob> _allFavoriteJobInsertionAdapter;

  final UpdateAdapter<AllFavoriteJob> _allFavoriteJobUpdateAdapter;

  @override
  Future<List<AllFavoriteJob>> getAllFavoriteJob() async {
    return _queryAdapter.queryList('SELECT * FROM AllFavoriteJob',
        mapper: (Map<String, Object?> row) => AllFavoriteJob(
            id: row['id'] as int?,
  ...
  Stream<AllFavoriteJob?> getAllFavoriteJobById(int id) {
    return _queryAdapter.queryStream(
        'SELECT * FROM AllFavoriteJob WHERE id = ?1',
        mapper: (Map<String, Object?> row) => AllFavoriteJob(
            id: row['id'] as int?,
            userId: row['userId'] as int?,
            like: row['like'] as int?,
            ...
            updatedAt: row['updatedAt'] as String?),
        arguments: [id],
        queryableName: 'AllFavoriteJob',
        isView: false);
  }

  @override
  Future<void> deleteAllFavoriteJob() async {
    await _queryAdapter.queryNoReturn('DELETE FROM AllFavoriteJob');
  }

  @override
  Future<void> insertAllFavoriteJob(AllFavoriteJob jobs) async {
    await _allFavoriteJobInsertionAdapter.insert(
        jobs, OnConflictStrategy.abort);
  }

  @override
  Future<void> updateAllFavoriteJob(AllFavoriteJob jobs) async {
    await _allFavoriteJobUpdateAdapter.update(jobs, OnConflictStrategy.abort);
  }
}
