...
class GetSearchJobUseCase implements Usecase<SearchEntity,SearchJobParams> {
  ...
  @override
  Future<Either<Failure, SearchEntity>> call(SearchJobParams params)async{
    return await jobsRepo.getSearchJobs(search: params.search);
  }
}

class SearchJobParams {
  String search;
  SearchJobParams({required this.search});
}