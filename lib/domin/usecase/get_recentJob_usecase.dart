...
class GetRecentJobUseCase implements Usecase<RecentJobEntity,RecentJobParams> {
  ...
  @override
  Future<Either<Failure, RecentJobEntity>> call(RecentJobParams params)async{
   return await jobsRepo.getRecentJobs();
  }
}

class RecentJobParams {}